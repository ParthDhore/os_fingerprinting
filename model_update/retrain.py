...
def backup_model(model_file, backup_dir):
...
def replace_model(new_model_file, model_file, backup_dir):
    """Replace the existing model file with the new one."""
    # Backup the current model file first
    backup_model(model_file, backup_dir)
...
def train_model():
    ...
    replace_model('model_update\\random_forest_model2.pkl', 'models\\random_forest_model.pkl', 'model_backups')
